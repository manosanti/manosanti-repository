...
function Navbar() {
  ...
  return (
    <>
      <div className="w-screen flex items-center max-w-7xl mx-auto justify-between h-16 text-white">
        <div>
        ...
        <div className="flex list-none items-center">
          ...
          <ul className="w-28">
            <li className="text-black bg-white p-1 font-medium rounded-md min-w-8">
